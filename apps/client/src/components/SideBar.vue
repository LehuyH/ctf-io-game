<template>
    <section ref="buildBar" class="fixed p-4 left-0 z-20 h-screen w-[30vw] bg-slate-200 bg-opacity-80 backdrop-blur-sm transition-transform pointer-events-auto" :class="sideBarClasses">
     ...
     <section class="max-h-screen overflow-y-scroll pb-28">
